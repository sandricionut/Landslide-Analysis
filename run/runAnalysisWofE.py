...
if __name__ == "__main__":
    ...
    for noise_value in noise_values:
        ...
        wofe_m.simulate(2, in_dem_sim=dem_simulate, landslide_sim=landslide_simulate, stats_file=out_stats_file, nominal_data=[inlulc, inlithology], mask=mask_raster, noise_factor=noise_value)
