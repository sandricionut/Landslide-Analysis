...
if __name__ == "__main__":
    ...
    dem_simulate = demSimulation.DemSimulations(in_dem=indem, out_dem=r"d:\Personal\Temp\Temporar\demsim.tif", mean=landslides_mapping_error_mean, stdev=landslides_mapping_error_stdev, noise_order=noise_order_value, temp_location=out_path_temp, mask=mask_raster)
    # dem_simulate.run()
    ...
    wofe_m = woefSimulation.WofESimulations(out_woe_map=out_path_woe)
